                ...
                if (bundle != null && bundle.containsKey("BUY_INTENT")) {
                    ...
                    if (intent != null) {
                        try {
                            ...
                            this.cordova.getActivity().startIntentSenderForResult(intent.getIntentSender(), BUY_INTENT_REQUEST_CODE,null,
                                    Integer.valueOf(0),
                                    Integer.valueOf(0),
                                    Integer.valueOf(0));
                             return true;
...
//            String agreement = getAgreementText(R.raw.customer_agreement);
    ...
    /*  */
    // public void onStop() {
    //     System.out.println("LAUNCH_BILLING: in onStop");
    // }
    // public void onCreate() {
    //     System.out.println("LAUNCH_BILLING: in onCreate");
    // }
    // public void onDestroy() {
    //     System.out.println("LAUNCH_BILLING: in onDestroy");
    // }

    // public void onRestoreStateForActivityResult(){
    //      System.out.println("LAUNCH_BILLING: in onRestoreStateForActivityResult");
    // }
